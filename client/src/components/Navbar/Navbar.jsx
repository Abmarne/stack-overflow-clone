    ...
    return (
        <nav className='main-nav'>
            <div className='navbar'>
                ...
                <a href='https://www.kommunicate.io/livechat-demo?appId=2c64de92d676238353532c5cfc33737ed&botIds=chatbot-7mpyi&assignee=chatbot-7mpyi' target='_blank' className='nav-item nav-btn'>ChatBot</a>
